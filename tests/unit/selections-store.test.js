...
describe('SelectionsStore', () => {
  ...
  describe('add()', () => {
    it('inserts an option for a new layer', () => {
    ...
    it('is idempotent for the same option id', () => {
    ...
    it('appends additional options for the same layer', () => {
      window.SelectionsStore.add('ide', { id: 'cursor', name: 'Cursor' });
  ...
  describe('remove()', () => {
    ...
    it('deletes the layer key when empty', () => {
      window.SelectionsStore.add('ide', { id: 'cursor', name: 'Cursor' });
      const next = window.SelectionsStore.remove('ide', 'cursor');
